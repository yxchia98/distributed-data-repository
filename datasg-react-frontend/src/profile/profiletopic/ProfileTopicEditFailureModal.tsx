...
interface ProfileTopicEditFailureModalProps {
    title: string;
    message: string;
    closeMessage: string;
    isOpen: boolean;
...
const ProfileTopicEditFailureModal: React.FC<ProfileTopicEditFailureModalProps> = (props) => {
    return (
        <>
...
export default ProfileTopicEditFailureModal;
