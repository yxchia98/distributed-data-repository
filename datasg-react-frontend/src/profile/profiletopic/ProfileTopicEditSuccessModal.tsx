...
interface ProfileTopicEditSuccessModalProps {
    title: string;
    message: string;
    closeMessage: string;
    isOpen: boolean;
...
const ProfileTopicEditSuccessModal: React.FC<ProfileTopicEditSuccessModalProps> = (props) => {
    return (
        <>
...
export default ProfileTopicEditSuccessModal;
