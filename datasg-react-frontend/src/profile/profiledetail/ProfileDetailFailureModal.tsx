...
interface ProfileDetailFailureModalProps {
    title: string;
    message: string;
    closeMessage: string;
    isOpen: boolean;
...
const ProfileDetailFailureModal: React.FC<ProfileDetailFailureModalProps> = (props) => {
    return (
        <>
...
export default ProfileDetailFailureModal;
