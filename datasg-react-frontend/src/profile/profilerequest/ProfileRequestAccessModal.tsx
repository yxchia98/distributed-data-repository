...
interface ProfileRequestAccessModalProps {
    title: string;
    message: string;
    closeMessage: string;
    isOpen: boolean;
...
const ProfileRequestAccessModal: React.FC<ProfileRequestAccessModalProps> = (props) => {
    return (
        <>
                                ...
                                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                                    ...
                                    <div className="flex flex-col justify-center rounded-md px-6 pt-5 pb-6 transition">
                                        {props.success && !props.loading && (
                                            <div className="flex justify-center items-center text-emerald-500">
...
export default ProfileRequestAccessModal;
