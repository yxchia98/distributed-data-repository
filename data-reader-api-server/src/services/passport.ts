...
passport.use(
    new GoogleStrategy(
        {
            clientID: <string>JSON.parse(process.env.GOOGLE_OAUTH_SECRETS).GOOGLE_CLIENT_ID,
            clientSecret: <string>JSON.parse(process.env.GOOGLE_OAUTH_SECRETS).GOOGLE_CLIENT_SECRET,
